...
@Component({
  selector: 'app-root',
  imports: [InterpolationComponent, PropetyBingingComponent, EventBindingComponent, TwoWayDataBindingComponent, TemplateDrivenComponent, ReactiveComponent, ReactiveFormBuilderComponent],
